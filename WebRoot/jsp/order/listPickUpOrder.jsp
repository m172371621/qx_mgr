...
<script type="text/javascript">
    ...
    function changeOrder() {
        ...
        if(confirm("确定要设置到货吗？")) {
            $.post('${pageContext.request.contextPath }/order.do?method=pickUpOrder', {ids : ids}, function(data) {
	...
	<div id="mr_cnt">
        <div class="mrw_title">订单提货</div>
            ...
            <div id="order_wrap" class="p20">
                <a href="javascript:changeOrder()" class="btn btn_big btn_y" style="margin-bottom: 5px;">设置提货</a>
