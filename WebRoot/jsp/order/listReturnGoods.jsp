...
<div id="mright">
	<div id="mr_cnt">
        <div class="mrw_title">退货查询</div>
        <form action="${pageContext.request.contextPath }/orderRefund.do?method=listReturnGoods" method="post" id="searchForm">
            ...
            <table class="table_t_t">
                ...
                <c:forEach items="${list}" var="refund">
                    <tr>
                        ...
                        <td>
                            <a target="_blank" href="${pageContext.request.contextPath}/orderRefund.do?method=showRefund&orderid=${refund.order_id}&objid=${refund.objid}" class="btn btn_r">退货</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
