...
<div id="mright">
	<div id="mr_cnt">
					...
					<div class="mrw_title">微信付款记录查询</div>
					...
					<form action="${pageContext.request.contextPath }/payLogCtrl.do?method=list_weixinpaylog"" method="post" id="searchForm">
					...
					<div id="order_wrap" class="p20">
						...
						<colgroup><col width="160px"/><col/><col/><col/></colgroup>
							...
							<% List<WeixinPayLogBean> list = (List<WeixinPayLogBean>)request.getAttribute("list");
							   if(list!=null){
							   for(WeixinPayLogBean oplog: list) {
							%>
							<tr>
								...
								<td><%= Double.parseDouble(JsonUtil.obj2Str(oplog.getPay_price()))/100 %></td>	
