	...
	<div id="mr_cnt">
					...
					<div class="sform_wrap c">
							...
							%>
								...
								<li>接受人：<input type="text" class="i_text" name="recv_user1"  value="<%= JsonUtil.obj2Str(searchBean.getRecv_user()) %>"/></li>
								...
								<li>任务状态：<select name="task_status1"  id="" class="i_text">
									...
									<option value="1" <% if(task_status==1||task_status==2) out.print("selected");%> >任务发布中</option>
									<option value="3" <% if(task_status==3||task_status==4||task_status==6||task_status==7) out.print("selected");%> >任务已完成</option>
									<option value="5" <% if(task_status==5) out.print("selected");%> >任务过期</option>
									<option value="9" <% if(task_status==9) out.print("selected");%> >任务审核中</option>
								</select>
								</li>
						...
						<form action="${pageContext.request.contextPath }/task.do?method=search" method="post" id="searchForm">
							...
							<input type="hidden" name="recv_user" value="<%= JsonUtil.obj2Str(searchBean.getRecv_user()) %>"/>
						...
						<script type="text/javascript">
							function submitForm()
							{
								...
								$("input[name='recv_user']").val($("input[name='recv_user1']").val());
