$(function () {
    ...
    function n() {
        ...
        if ($(".J_menuTab").each(function () {
            ...
            var r = '<iframe class="J_iframe" name="iframe' + a + '" width="100%" height="100%" src="' + ctx + t + '" frameborder="0" data-id="' + t + '" seamless></iframe>';
            $(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").append(r);
            //var o = layer.load(0, {shade: false});
