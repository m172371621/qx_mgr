...
/////////////////////////////////////////////////////////////////////
    ...
    var detailGridColumn = [
        ...
        {id:'deadline', title:'到期时间', type:'date', format:'yyyy-MM-dd', columnClass:'text-center', hideType:'xs'},
        {id:'puhuo_flag', title:'是否铺货', type:'string', columnClass:'text-center', hideType:'xs', codeTable : puhuo_flag},
        {id:'supplier_name', title:'供应商', type:'string', columnClass:'text-center', hideType:'xs'},
