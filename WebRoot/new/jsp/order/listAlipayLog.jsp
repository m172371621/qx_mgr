...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <div id="alipayTable" class="dt-grid-container"></div>
                        <div id="alipayToolBar" class="dt-grid-toolbar-container"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        var gridColumn = [
            ...
            {id:'total_fee', title:'支付宝支付金额', type:'string', columnClass:'text-center', hideType:'xs'},
        ...
        var gridOption = {
            ajaxLoad : true,
            loadURL : '${ctx}/payLogCtrl.do?method=listAlipayLog',
            columns : gridColumn,
            gridContainer : 'alipayTable',
            toolbarContainer : 'alipayToolBar',
            tools : ''
        };
