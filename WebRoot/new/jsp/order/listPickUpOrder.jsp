        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="btn-group">
                        <button type="button" class="btn btn-outline btn-primary" onclick="pickUpOrder()">
                            设置提货
                        </button>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <ul class="nav nav-tabs disabled">
                                <li class="active" data-status="1,2,22"><a data-toggle="tab" aria-expanded="false">待收货</a></li>
                            </ul>
                        </div>
                    ...
                    <form role="form" class="form-horizontal" id="queryForm" style="display: none;">
                        ...
                        <input type="hidden" id="order_status_array" value="1,2,22"/>
...
<script type="text/javascript">
    function pickUpOrder() {
        ...
        if(records.length == 0) {
            layer.alert("请先选中需要提货的订单");
        } else {
            layer.confirm("确定要提货吗？", function(index) {
                var ids = '';
                ...
                var n = layer.load();
                $.post('${ctx}/order.do?method=pickUpOrder', {ids : ids}, function(data) {
    ...
    function search() {
        ...
        grid.parameters['delivery_type'] = delivery_type;
