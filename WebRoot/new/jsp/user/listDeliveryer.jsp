        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" id="editForm">
                    ...
                    <div class="form-group">
                        <label for="distri_worker_name_edit" class="col-md-4 control-label text-right">姓名<span class="text-danger">*</span></label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="distri_worker_name_edit" name="distri_worker_name" data-rule="required">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="distri_worker_phone_edit" class="col-md-4 control-label text-right">手机号<span class="text-danger">*</span></label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="distri_worker_phone_edit" name="distri_worker_phone" data-rule="required">
                        </div>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    var gridOption = {
        ajaxLoad: true,
        loadURL: '${ctx}/user.do?method=searchDeliveryer',
        columns: gridColumn,
    ...
    function clearEditForm() {
        ...
        $('#loginname_edit').val('');
        $('#password_edit').val('');
        $('#distri_worker_name_edit').val('');
        $('#distri_worker_phone_edit').val('');
            ...
            $.post('${ctx}/user.do?method=getMgrUserById', {user_id : user_id}, function(data) {
                if(data) {
                    ...
                    if(json) {
                        ...
                        $('#distri_worker_name_edit').val(json.mgrUser.distri_worker_name);
                        $('#distri_worker_phone_edit').val(json.mgrUser.distri_worker_phone);
    ...
    function saveUser() {
        if($('#editForm').isValid()) {
            layer.confirm("确定要保存吗？", function() {
                var i = layer.load();
                $.post('${ctx}/user.do?method=saveDeliveryer', $('#editForm').serialize(), function(data) {
                    if(data) {
                        var json = eval('(' + data + ')');
                        if(json) {
                            if(json.result) {
