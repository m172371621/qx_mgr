 ...
 */
@Component
public class PushPhoneOrderJob {

    private static final Logger LOGGER = Logger.getLogger(PushPhoneOrderJob.class);
                        ...
                        if (null != temps && temps.size() > 0) {
                            ...
                            for (Map temp : temps) {
                                ...
                                for(Map user_id : tempUser_id) {
                                    ...
                                    msgmap.put("URL", "http://mgr.qxit.com.cn/qx_mgr/phoneorderctrl/phonePage.do");
    ...
    public void pushChengZhong() {
        try {
                        ...
                        if (null != temps && temps.size() > 0) {
                            ...
                            for (Map temp : temps) {
                                ...
                                for(Map user_id : tempUser_id) {
                                    ...
                                    msgmap.put("URL", "http://mgr.qxit.com.cn/qx_mgr/weighProduct/pwmanager.do");
            ...
            LOGGER.error("pushChengZhong error:" + e);
        }
    }
}
